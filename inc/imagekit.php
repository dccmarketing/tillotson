 ...
 */
function tillotson_get_customizer_image_info( $name ) {
	...
	$id = tillotson_get_image_id( $image_url );
...
} // tillotson_get_customizer_image_info()
 ...
 */
function tillotson_get_featured_images( $postID ) {
 ...
 */
function tillotson_get_image_id( $image_url ) {
 ...
 */
function tillotson_get_svg( $svg ) {

	if ( empty( $svg ) ) { return; }

	$list = tillotson_get_svg_list();
 ...
 * Returns the requested SVG
 *
 * @exits 		If $svg is empty.
 * @param 		string 		$svg 		The name of the icon to return
 * @return 		mixed 					The SVG code
 */
function tillotson_get_svg_list() {
	...
	/**
	 * The tillotson_svgs filter
	 */
	$list = apply_filters( 'tillotson-svgs', $list );

	return $list;

} // tillotson_get_svg_list()
 ...
 */
function tillotson_get_thumbnail_url( $postID, $size = 'thumbnail' ) {
 ...
 */
function tillotson_get_video_thumb( $embed_code ) {

	$return = '';

	$service = tillotson_get_video_service( $embed_code );
	$videoID = tillotson_get_video_id( $service, $embed_code );
	...
	if ( preg_match( '~youtu~', $embed_code ) ) {
		...
		$thumb 	= tillotson_get_vimeo_thumb( $video_id[1] );
...
} // tillotson_get_video_thumb()

function tillotson_get_video_service( $string ) {
	 ...
	 */
	$checks 	= apply_filters( 'tillotson-video-services', $checks, $string );
	$service 	= FALSE;
 ...
 */
function tillotson_get_video_id( $service, $string ) {
 ...
 */
function tillotson_get_vimeo_thumb( $videoid ) {
 ...
 * @return 		mixed 					The SVG code
 */
function tillotson_the_svg( $svg ) {

	if ( empty( $svg ) ) { return FALSE; }

	echo tillotson_get_svg( $svg );
