...
add_action( 'customize_register', 'tillotson_register_panels' );
add_action( 'customize_register', 'tillotson_register_sections' );
add_action( 'customize_register', 'tillotson_register_fields' );

// Output custom CSS to live site
add_action( 'wp_head', 'tillotson_header_output' );

// Enqueue live preview javascript in Theme Customizer admin screen
add_action( 'customize_preview_init', 'tillotson_live_preview' );

// Enqueue scripts for the customizer controls
add_action( 'customize_controls_enqueue_scripts', 'tillotson_control_scripts' );
 ...
 * @since 		1.0.0
 */
function tillotson_register_panels( $wp_customize ) {

	//

} // tillotson_register_panels()
 ...
 * @since 		1.0.0
 */
function tillotson_register_sections( $wp_customize ) {
 ...
 * @since 		1.0.0
 */
function tillotson_register_fields( $wp_customize ) {
 ...
 */
function tillotson_generate_css( $selector, $style, $mod_name, $prefix = '', $postfix = '', $echo = true ) {
 ...
 * @since 		1.0.0
 */
function tillotson_header_output() {
	...
	<style type="text/css"><?php
		...
		tillotson_generate_css( '#promo-box-1:before', 'background-image', 'promo_box_1_bg', 'url(', ')' );
		tillotson_generate_css( '#promo-box-2:before', 'background-image', 'promo_box_2_bg', 'url(', ')' );
		tillotson_generate_css( '#promo-box-3:before', 'background-image', 'promo_box_3_bg', 'url(', ')' );

		// pattern:
		// tillotson_generate_css( 'selector', 'style', 'mod_name', 'prefix', 'postfix', true );
		//
		// background-image example:
		// tillotson_generate_css( '.class', 'background-image', 'background_image_example', 'url(', ')' );


	?></style><!-- Customizer CSS --><?php

} // tillotson_header_output()
 ...
 * @since 		1.0.0
 */
function tillotson_live_preview() {
 ...
 * @since 		1.0.0
 */
function tillotson_control_scripts() {

	wp_enqueue_script( 'tillotson_customizer_controls', get_template_directory_uri() . '/js/customizer-controls.min.js', array( 'jquery', 'customize-controls' ), false, true );

} // tillotson_control_scripts()
